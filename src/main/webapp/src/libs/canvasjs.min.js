            ...
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                if (!(b && 1 < b.length)) {
                    ...
                    try { var k = e.y - this._lastTouchData.y,
                            g = e.time - this._lastTouchData.time; if (1 < Math.abs(k) && this._lastTouchData.scroll || 5 < Math.abs(k) && 250 > g) this._lastTouchData.scroll = !0 } catch (l) {}
            ...
            function h(a, b, c) {
                ...
                if (0 === W.length) k =
                    ia;
                        ...
                        k.push(ia[q] + d); if (0 <= W.indexOf(q) || q < P.length && 0 <= W.indexOf(q + 1)) d += e } }
        ...
        p.prototype.replaceKeywordsWithValue = function(a, d, b, c, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try { var f = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    f && 0 < f.length && (k = Ia(f[2]), a = Ia(f[1])) } catch (l) {}
                f = null;
